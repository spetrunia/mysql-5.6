...
enum {
  ...
  PC_RANGELOCK_SYNCHRONIZE_RCU,
  PC_RANGELOCK_ACQUIRE_RCU_BUSY1,
  PC_RANGELOCK_ACQUIRE_RCU_RETRY,

  PC_RANGELOCK_RCU_ENABLED,
  PC_RANGELOCK_RARE_EVENT,

  PC_RANGELOCK_DISABLE_RCU_HIT_ROOT,
  PC_RANGELOCK_DISABLE_RCU_MAYBE_REBALANCE,
  PC_RANGELOCK_DISABLE_RCU_REBALANCE,
